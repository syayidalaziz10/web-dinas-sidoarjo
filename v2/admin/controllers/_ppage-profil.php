...
//SELECT prof_id, prof_lnm, prof_snm, prof_addr, prof_fax, prof_telp, prof_mail, prof_maps, prof_skm, prof_desk, prof_lg, _active, _cre, _cre_date, _chg, _chg_date FROM pub_profile WHERE 1
	...
	switch($_REQUEST['_act']){
		case 1:
				...
				$insert = $mysqli->query("INSERT INTO pub_profile(prof_id, prof_lnm, prof_snm, prof_addr, prof_fax, prof_telp, prof_mail, prof_pwd, prof_maps, prof_skm, prof_desk, prof_lg, _active, _cre, _cre_date, _chg, _chg_date) 
											VALUES('$prof_id','$prof_lnm','$prof_snm','$prof_addr','$prof_fax','$prof_telp','$prof_mail','$prof_pwd','$prof_maps','$prof_skm','$prof_desk','$prof_lg',
		...
		case 4:
				...
				$result = $mysqli->query("SELECT prof_id, prof_lnm, prof_snm, prof_addr, prof_fax, prof_telp, prof_mail, prof_pwd, prof_maps, prof_skm, prof_desk, prof_lg
											FROM pub_profile 
											WHERE _active=1")
