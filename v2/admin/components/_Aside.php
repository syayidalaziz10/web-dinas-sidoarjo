                ...
                <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
							...
							<li>
								<a href="javascript:void(0)" onClick="goPublic('_page-pic','2','publikasi-galery','publikasi_galery')">
									<i class="fal fa-images"></i>
									<span class="nav-link-text" data-i18n="nav.pages_forum_list">Galery</span>
								</a>
							</li>
                        </ul>
