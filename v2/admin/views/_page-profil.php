								...
								<div class="col-sm-8">
									...
									<div class="form-row">
										<div class="col-md-6 mb-3">
											...
											<input type="number" class="form-control" id="prof_telp" name="prof_telp" autocomplete="off" placeholder="Telepon">
										</div>
										<div class="col-md-6 mb-3">
											<label class="form-label">Fax</label>
											<input type="number" class="form-control" id="prof_fax" name="prof_fax" autocomplete="off" placeholder="Faximil">
										</div>
									</div>
									<div class="form-row">
										<div class="col-md-6 mb-3">
