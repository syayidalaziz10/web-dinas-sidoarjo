            ...
            <div class="row">
              <div class="col-lg-6 col-md-8 col-sm-12">
                ...
                <ul class="breadcrumb p-l-0 p-b-0 ">
                  ...
                  <li class="breadcrumb-item active">Edit Dinas</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <form class="" action="" method="post" enctype="multipart/form-data">
            <div class="header">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="dinas" placeholder="Singkatan Dinas" value="<?=$data->name ?>" required />
              </div>
              <div class="form-group">
                <input type="file" class="form-control" name="image" id="image" />
              </div>
              <div class="body">
                <textarea class="form-control" placeholder="url dinas : https://example.com/" name="desc" required> <?=$data->description ?></textarea>
              </div>
              <div class="row clearfix">
