                ...
                <div class="row clearfix">
                  ...
                  <div class="col-sm-9">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="date" class="form-control datetimepicker" value="<?=$data->date ?>" placeholder="Pilih tanggal dan waktu">
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
