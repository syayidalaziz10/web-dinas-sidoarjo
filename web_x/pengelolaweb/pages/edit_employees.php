...
$id = (int)$_GET['_pid'];
$data = Settings::EmployeesGetID($id, $dbCon);
...
<section class="content">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-8 col-sm-12">
                ...
                <ul class="breadcrumb p-l-0 p-b-0 ">
                  ...
                  <li class="breadcrumb-item active">Edit Pegawai <b><?=$data->name ?> </b></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="header">
              ...
              <div class="row clearfix">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" name="bagian" value="<?=$data->bagian ?>" placeholder="Bagian" required />
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" name="tahun" value="<?=$data->tahun ?>" placeholder="Tahun <?=date("Y"); ?>" required />
                  </div>
                  <div class="form-group">
  ...
  if(isset($_POST['tambah'])){
    Settings::EmployeesUpdate($_POST, $dbCon, $id);
  } ?>
