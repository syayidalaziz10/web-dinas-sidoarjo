...
$id = (int)$_GET['_ews'];
$data = Settings::ApiGetID($id, $dbCon);
...
<section class="content">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-8 col-sm-12">
                ...
                <ul class="breadcrumb p-l-0 p-b-0 ">
                  ...
                  <li class="breadcrumb-item"><a href=".?_pg=<?=$_GET['_pg'] ?>&_act=<?= encodeUrl('list_api') ?>">Pengaturan Link API</a></li>
          ...
          <form class="" action="" method="post" enctype="multipart/form-data">
            <div class="header">
              ...
              <div class="form-group">
                <input type="text" class="form-control"  name="nama" value="<?=$data->name ?>" placeholder="Nama API" required />
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="url" value="<?=$data->value ?>" placeholder="Url"  required />
              </div>
              <div class="row clearfix">
  ...
  if(isset($_POST['tambah'])){
    Settings::ApiUpdate($_POST, $dbCon, $id);
  } ?>
