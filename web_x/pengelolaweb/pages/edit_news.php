                ...
                <div class="row clearfix">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group">
                      <input type="text" class="form-control" maxlength="110" name="title" value="<?=$data->title ?>" placeholder="Judul Info" required />
                    </div>
                    <div class="form-group">
