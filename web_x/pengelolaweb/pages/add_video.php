          ...
          <form class="" action="" method="post" enctype="multipart/form-data">
            <div class="header">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="title" placeholder="Judul Video" required />
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="idvideo" placeholder="Url video youtube" required />
              </div>
