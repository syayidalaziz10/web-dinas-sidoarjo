...
<section class="content">
          ...
          <div class="body block-header">
            <div class="row">
              <div class="col-lg-6 col-md-8 col-sm-12">
                <h2>Edit Pengaturan <?=$data->name ?></h2>
        ...
        <div class="card">
          <form class="" action="" method="post" enctype="multipart/form-data">
            <div class="header">
              ...
              <div class="body">
                <textarea class="form-control" placeholder="Deskripsi singkat" rows="5" name="desc"><?=$data->value ?></textarea>
              </div>
              <div class="row clearfix">
  ...
  if(isset($_POST['tambah'])){
    Settings::Update($_POST, $dbCon, $id);
  } ?>
