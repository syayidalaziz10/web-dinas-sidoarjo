...
if(empty($_SESSION["UID"]) && empty($_SESSION["FNAME"]) && empty($_SESSION["EMAIL"]) && empty($_SESSION["LEVEL"]) && $_SESSION["SNAME"] !== $_SERVER['SERVER_NAME']){
              ...
              <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                  ...
                  <ul class="breadcrumb p-l-0 p-b-0 ">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Visi Misi</a></li>
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group">
                      <input type="text" class="form-control" name="title" value="<?=$data->title ?>" placeholder="Judul Visi Misi" required />
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
  ...
  if(isset($_POST['tambah'])){
    VisiMisi::Update($_POST, $dbCon, $id);
  } ?>
