                ...
                <div class="row clearfix">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group">
                      <input type="text" class="form-control" name="title" placeholder="Judul agenda" required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="date" class="form-control datetimepicker" placeholder="Pilih tanggal dan waktu">
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
