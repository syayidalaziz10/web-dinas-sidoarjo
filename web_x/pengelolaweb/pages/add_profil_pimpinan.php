            ...
            <div class="row">
              <div class="col-lg-6 col-md-8 col-sm-12">
                ...
                <ul class="breadcrumb p-l-0 p-b-0 ">
                  ...
                  <li class="breadcrumb-item active">Tambah Profil Pimpinan </b></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="header">
              ...
              <div class="row clearfix">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" maxlength="10" name="tahun" value="" placeholder="Tahun <?=date("Y") ?> - <?=date("Y", strtotime('+ 5 years')) ?>" required />
                  </div>
                  <div class="form-group">
