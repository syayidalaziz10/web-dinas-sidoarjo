    ...
    <div class="container">
      <div class="row">
              ...
              <li class="breadcrumb-item">
                <a href="../<?= $_kategori?>/" class="d-flex align-items-center">
                  ...
                  if (!empty($category['ca_icon'])) {
                    echo '<img class="cat-image mr-2" src="'.$rLink.$_dirKategori.$category['ca_icon'].'"></img>';
                  } 
                  */
                  ?>
        ...
        <div class="col-lg-7 mr-lg-5">
		  ...
		  if (!empty($image)) {
            echo '<img src="'.$rLink.$_dirPost.$image.'" alt="" class="img-fluid rounded-lg detail-img-banner">';
          }
                        ...
                        ?>
                            <div class="files-table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#pdfModal" data-pdfsrc="<?= $rLink.$_dirFiles.$title ?>">Lihat</a>
                                </div>
                                <div class="table-cell">
                                    <span class="icon-download mr-2"></span>
                                    <a href="<?=$rLink.$_dirFiles?>force.php?file=<?= urlencode($title) ?>">Download</a>
                                </div>
                            </div>
                        <?php
                            } // Penutup dari if
