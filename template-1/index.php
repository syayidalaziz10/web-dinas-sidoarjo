<?php 
  ...
  $video =  $mysqli->query('SELECT sos_url from pub_socials WHERE _active=1 ORDER BY _cre_date DESC LIMIT 1');
      ...
      <div class="row justify-content-between">
        <div class="col-lg-4">
          ...
          <div class="mb-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <a href="media" class="btn btn-outline-primary">Lihat media lainnya</a>
          </div>
        </div>
