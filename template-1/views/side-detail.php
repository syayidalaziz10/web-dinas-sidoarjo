<div class="col-lg-4 mt-lg-0 mt-5">
   ...
   <div class="row">
      ...
      $query = $mysqli->query("SELECT * FROM pub_post WHERE ca_id=001 ORDER BY post_see DESC LIMIT 4");
   ...
   <div class="row">
      ...
      $query = $mysqli->query("SELECT * FROM pub_post WHERE ca_id=001 ORDER BY post_publish DESC LIMIT 4");
      $news = $query->fetch_all(MYSQLI_ASSOC);
