...
$sql = "SELECT emp_id, parent FROM pub_employees WHERE parent!='' AND _active=1";
...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_assoc()) {
		...
		$json[]=[(string)$row["parent"] , (string)$row["emp_id"]];
...
$sqlPerson = "SELECT emp_id, emp_nm, emp_img, jab_id, dept_id, parent FROM pub_employees WHERE _active=1";
