...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="100" class="bg-light">
        ...
        <div class="col-12">
          <div class="row justify-content-center">
            <div class="col-12 text-center">
              <h1 class="heading" data-aos="fade-up" data-aos-delay="0"><?= $category['ca_nm']?></h1>
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <?php
      ...
      $query = "SELECT * FROM pub_post WHERE ca_id=$_kategori ORDER BY post_publish DESC LIMIT $limit_start, $limit";
      ...
      while ($row = $res1->fetch_assoc()) {
        ...
        if (!empty($row['post_img'] && file_exists($dir_image) )) {
          $src = $rLink. $_dirPost . $row['post_img'];
        } else {
          $src = $rLink. $_dirPost . 'default.png';
        }
