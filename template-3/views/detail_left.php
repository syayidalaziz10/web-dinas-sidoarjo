...
<div class="card shadow-sm mb-3">
    ...
    ?>
        <div class="d-flex flex-row post-item">
            ...
            <div>
                <a href="../001/<?= $id?>">
                    <h6 class="card-title " style="text-align:justify ;"><?= $title ?></h6>
                </a>

                <ul>
                    <li class="date-item"><i class="bi bi-calendar-event-fill"></i><span> <?= dateToDay($date) ?></span>
                    </li>
                    <!-- <li class="view-item"><i class="bi bi-eye-fill"></i> <span>Dibaca <?= $see ?> kali</span></li> -->
                </ul>
    ...
    <div class="container">
      ...
      ?>
        <div class="d-flex flex-row post-item">
            ...
            <div>
                <a href="../002/<?= $id?>">
                    <h6 class="card-title text-justify"><?= $title ?></h6>
                </a>
